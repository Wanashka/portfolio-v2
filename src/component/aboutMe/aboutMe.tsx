            ...
            <div className={s.mainBlockAboutMe}>
                ...
                <div className={s.textBlock}>
                    ...
                    <div className={s.descriptionBlock}>
                        Я молодой и амбициозный разработчик, глубоко увлеченный миром программирования. Мой
                        профессиональный путь отличается стремлением к постоянному обучению и развитию, чтобы оставаться
